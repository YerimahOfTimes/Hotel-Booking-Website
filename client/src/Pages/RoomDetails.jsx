  ...
  return room &&(
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        <div className='flex flex-col md:flex-row items-start md:items-center gap-2'>
            ...
            {/* Room Highlight */}
            <div className='flex flex-col md:flex-row md:justify-between-19'>
            ...
            mx-auto mt-16 max-w-6xl'>
                ...
                md:items-center gap-4 md:gap-10 text-gray-500'>
                    <div className='flex flex-col'>
                        ...
                        w-full rounded border border-gray-300 px-3 py-2 mt-1.5
                    ...
                    <div className='flex flex-col'>
                        ...
                        <input type='number' id='CheckInDate' placeholder='0' className='
                        max-w-20 rounded border border-gray-300 px-3 py-2 mt-1.5
                        outline-one' required/>
                    </div>
            ...
            <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
                ...
                price quoted is for two guest,at the guest slot please mark the number of guest to get the exact price for the groups. The guest will be allocated ground floor according to availability.You get the comfortable two bedroom
