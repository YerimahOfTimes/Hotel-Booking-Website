        ...
        <div>
            <div className='flex flex-col items-start text-left'>
                ...
                <p className='text-sm md:text-base text-gray-500/90 mt-2'>
                    ...
                    packages to enhanced your stay and create unforgettable memories.
                </p>
            ...
            {roomsDummyData.map((room)=>(
                ...
                py-10 gap-6 border-gray-300 last:pb-30 last:border-0'>
                    ...
                    <div className='md:w-1/2 flex flex-col gap-2'>
                        ...
                        <div>
                            {room.amenities.map((item,index)=>(
                                ...
                                px-3 py-2 rounded-lg bg-[#5F5FF]/70'>
        ...
        max-lg:mb-8 `lg:mt-16`'>
            ...
            lg:border-b border-gray-300 ${openFilters && "border-b"}`}>
                ...
                <div className='text-xs cursor-pointer'>
                    <span onClick={()=> setOpenFiters(!openFilters)} className='lg:hidden'>{openFilters ? 'HIDE' : 'SHOW'}</span>
