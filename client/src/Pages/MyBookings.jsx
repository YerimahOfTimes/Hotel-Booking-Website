...
const MyBookings = () => {
  ...
  return (
    <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        upcoming hotel reservations in one place. Plane your trips seamlessly with
        just a few click' align='left'/>
        ...
        <div className='max-w-6xl mt-8 w-full text-gray-800 '>
            ...
            {bookings.map((bookings)=>(
                <div key={bookings._id} className='grid grid-cols-1 md:grid-cols-
                ...
                <div className='flex flex-col items-start justify-center pt-3'>
                    <div className='flex items-center gap-2'>
                        ...
                        <p className={`text-sm ${booking.isPaid ? "tex-green-500" :
